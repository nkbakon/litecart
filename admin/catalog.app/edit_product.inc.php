...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('product_form', 'post', false, true, 'id="product_form_id" onsubmit="return validateForm()"'); ?>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <?php echo functions::form_draw_date_field('date_valid_from', true, 'id="validfrom"'); ?>
                <span id="error-message" style="color: red; display: none;">This field is required.</span>
                <span id="error-message4" style="color: red; display: none;">Valid from date must be less than or equal to Valid to date.</span>
              </div>

              <div class="form-group">
                <label><?php echo language::translate('title_date_valid_to', 'Date Valid To'); ?></label>
                <?php echo functions::form_draw_date_field('date_valid_to', true, 'id="validto"'); ?>
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
                <label><?php echo language::translate('title_name', 'Name'); ?></label>
                 <?php echo functions::form_draw_regional_input_field(settings::get('store_language_code'), 'name['. settings::get('store_language_code') .']', true, 'id="name"'); ?>
              ...
              <div class="form-group">
                <label><?php echo language::translate('title_price', 'Price'); ?></label>
                 <?php echo functions::form_draw_currency_field(settings::get('store_currency_code'), 'prices['. settings::get('store_currency_code') .']', true, 'id="price"'); ?>
            ...
            <div id="<?php echo $language_code; ?>" class="tab-pane fade in<?php echo ($language_code == language::$selected['code']) ? ' active' : ''; ?>">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label><?php echo language::translate('title_name', 'Name'); ?></label>
                    <?php echo functions::form_draw_regional_input_field($language_code, 'name['. $language_code .']', true, 'id="infoname"'); ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php echo functions::form_draw_regional_input_field($language_code, 'short_description['. $language_code .']', true, 'id="infosdes"'); ?>
                    <span id="error-message6" style="color: red; display: none;">This field is required.</span>
                  </div>

                  <div class="form-group">
                    <label><?php echo language::translate('title_description', 'Description'); ?></label>
                    <?php echo functions::form_draw_regional_wysiwyg_field($language_code, 'description['. $language_code .']', true, 'style="height: 250px;" id="infodes"'); ?>
        ...
        <div id="tab-prices" class="tab-pane">
          ...
          <div id="prices" style="max-width: 640px;">
            ...
            <table class="table table-striped data-table">
              <thead>
                <tr>
                  <td style="width: 50%;"><?php echo language::translate('title_price', 'Price'); ?> <span id="error-message8" style="color: red; display: none;">This field is required.</span></td>
                  <td style="width: 50%;"><?php echo language::translate('title_price_incl_tax', 'Price Incl. Tax'); ?> (<a id="price-incl-tax-tooltip" href="#">?</a>) <span id="error-message9" style="color: red; display: none;">This field is required.</span></td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td><?php echo functions::form_draw_currency_field(settings::get('store_currency_code'), 'prices['. settings::get('store_currency_code') .']', true, 'data-currency-price="" placeholder="" id="pprice"'); ?></td>
                  <td><?php echo functions::form_draw_decimal_field('gross_prices['. settings::get('store_currency_code') .']', '', currency::$currencies[settings::get('store_currency_code')]['decimals'], 0, null, 'placeholder="" id="ptaxprice"'); ?></td>
                </tr>
<?php
...
function validateForm() {
  const fields = [
    { id: 'validfrom', message: '#error-message' },
    { id: 'validto', message: '#error-message1' },
    { id: 'name', message: '#error-message2' },
    { id: 'price', message: '#error-message3' },
    { id: 'infoname', message: '#error-message5' },
    { id: 'infosdes', message: '#error-message6' },
    { id: 'infodes', message: '#error-message7' },
    { id: 'pprice', message: '#error-message8' },
    { id: 'ptaxprice', message: '#error-message9' },
  ];
  ...
  const dateErrorMessage = $('#error-message4');

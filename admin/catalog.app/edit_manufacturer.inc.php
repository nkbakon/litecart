...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('manufacturer_form', 'post', false, true, 'id="manufacturer_form_id" onsubmit="return validateForm()"'); ?>
          ...
          <div class="tab-content">
            ...
            <div id="<?php echo $language_code; ?>" class="tab-pane fade in<?php echo ($language_code == language::$selected['code']) ? ' active' : ''; ?>">
              ...
              <div class="form-group">
                ...
                <?php echo functions::form_draw_regional_input_field($language_code, 'h1_title['. $language_code .']', true, 'id="title"'); ?>
              ...
              <div class="form-group">
                ...
                <?php echo functions::form_draw_regional_input_field($language_code, 'short_description['. $language_code .']', true, 'id="sdesc"'); ?>
                <span id="error-message3" style="color: red; display: none;">This field is required.</span>
              </div>

              <div class="form-group">
                <label><?php echo language::translate('title_description', 'Description'); ?></label>
                <?php echo functions::form_draw_regional_wysiwyg_field($language_code, 'description['. $language_code .']', true, 'style="height: 240px;" id="desc"'); ?>
...
<script>
  function validateForm() {
    const fields = [
      ...
      { id: 'title', message: '#error-message2' },
      { id: 'sdesc', message: '#error-message3' },
      { id: 'desc', message: '#error-message4' },
    ];

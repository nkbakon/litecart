...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('country_form', 'post', false, false, 'style="max-width: 640px;" id="country_form_id" onsubmit="return validateForm()"'); ?>
      ...
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <?php echo functions::form_draw_text_field('iso_code_1', true, 'id="number" required pattern="[0-9]{3}"'); ?>
      ...
      <div class="row">
        <div class="form-group col-md-6">
          ...
          <?php echo functions::form_draw_text_field('iso_code_2', true, 'id="code1" required pattern="[A-Z]{2}"'); ?>
        ...
        <div class="form-group col-md-6">
          ...
          <?php echo functions::form_draw_text_field('iso_code_3', true, 'id="code2" required pattern="[A-Z]{3}"'); ?>

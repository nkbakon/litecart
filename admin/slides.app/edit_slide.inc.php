...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('slide_form', 'post', false, true, 'id="slide_form_id" onsubmit="return validateForm()" style="max-width: 640px;"'); ?>
      ...
      <div class="tab-content">
        ...
        <div id="<?php echo $language_code; ?>" class="tab-pane fade in<?php echo ($language_code == language::$selected['code']) ? ' active' : ''; ?>">
          <div class="form-group">
            ...
            <?php echo functions::form_draw_regional_wysiwyg_field($language_code, 'caption['. $language_code .']', true, 'id="caption" style="height: 240px;"'); ?>
...
<script>
  function validateForm() {
    const fields = [
      ...
      { id: 'caption', message: '#error-message1' },
      { id: 'validfrom', message: '#error-message2' },
      { id: 'validto', message: '#error-message3' },
    ];

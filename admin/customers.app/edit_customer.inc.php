...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php
      echo functions::form_draw_form_begin('customer_form', 'post', '', false, 'autocomplete="off" id="customer_form_id" onsubmit="return validateForm()"');
    ?>
        ...
        <div class="col-md-8">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <?php echo functions::form_draw_text_field('tax_id', true, 'id="tax"'); ?>
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <?php echo functions::form_draw_text_field('firstname', true, 'id="fname"'); ?>
              <span id="error-message4" style="color: red; display: none;">This field is required.</span>
            </div>

            <div class="form-group col-md-6">
              <label><?php echo language::translate('title_lastname', 'Last Name'); ?></label>
              <?php echo functions::form_draw_text_field('lastname', true, 'id="lname"'); ?>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <?php echo functions::form_draw_password_field('new_password', '', 'autocomplete="new-password" id="password"'); ?>
              <span id="error-message10" style="color: red; display: none;">This field is required.</span>
              <span id="error-message11" style="color: red; display: none;">Password must be at least 6 characters long.</span>
            </div>
          </div>
...
function validateForm() {
  const fields = [
    ...
    { id: 'code', message: '#error-message1' },
    { id: 'company', message: '#error-message2' },
    { id: 'tax', message: '#error-message3' },
    { id: 'fname', message: '#error-message4' },
    { id: 'lname', message: '#error-message5' },
    { id: 'address', message: '#error-message6' },
    { id: 'postal', message: '#error-message7' },
    { id: 'city', message: '#error-message8' },
    { id: 'phone', message: '#error-message9' },
    { id: 'password', message: '#error-message10' },
  ];
  ...
  const passwordErrorMessage = $('#error-message11');

...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('tax_rate_form', 'post', false, false, 'id="taxrate_form_id" onsubmit="return validateForm()" style="max-width: 640px;"'); ?>
      ...
      <div class="card-action">
        ...
        <?php echo !empty($tax_rate->data['id']) ? functions::form_draw_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'formnovalidate class="btn btn-danger" onclick="if (!confirm(&quot;'. language::translate('text_are_you_sure', 'Are you sure?') .'&quot;)) return false;"', 'delete') : false; ?>

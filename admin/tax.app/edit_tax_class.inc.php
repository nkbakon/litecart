...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('tax_class_form', 'post', false, false, 'id="slide_form_id" onsubmit="return validateForm()" style="max-width: 640px;"'); ?>
      ...
      <div class="form-group">
        ...
        <?php echo functions::form_draw_text_field('description', true, 'id="desc"'); ?>

...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('language_form', 'post', false, false, 'id="lang_form_id" onsubmit="return validateForm()" style="max-width: 640px;"'); ?>
      ...
      <div class="row">
        <div class="form-group col-md-6">
          ...
          <?php echo functions::form_draw_text_field('code', true, 'id="code1" required pattern="[a-z]{2}"'); ?>
        ...
        <div class="form-group col-md-6">
          ...
          <?php echo functions::form_draw_text_field('code2', true, 'id="code2" required pattern="[a-z]{3}"'); ?>
      ...
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <?php echo functions::form_draw_text_field('locale', true, 'id="locale" placeholder="E.g. en_US.utf8,en-US.UTF-8,english"'); ?>
      ...
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <?php echo functions::form_draw_text_field('domain_name', true, 'id="domain"'); ?>
...
<script>
  function validateForm() {
    const fields = [
      ...
      { id: 'code1', message: '#error-message1' },
      { id: 'code2', message: '#error-message2' },
      { id: 'locale', message: '#error-message3' },
      { id: 'domain', message: '#error-message4' },
    ];

...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('currency_form', 'post', false, false, 'style="max-width: 640px;"  id="currency_form_id" onsubmit="return validateForm()"'); ?>
      ...
      <div class="card-action">
        ...
        <?php echo !empty($currency->data['id']) ? functions::form_draw_button('delete', language::translate('title_delete', 'Delete'), 'submit', 'formnovalidate class="btn btn-danger" onclick="if (!confirm(&quot;'. language::translate('text_are_you_sure', 'Are you sure?') .'&quot;)) return false;"', 'delete') : ''; ?>
...
function validateForm() {
  ...
  if (nameField.val().trim() === '') {
    errorMessage.css('display', 'inline'); // Display the error message
    return false; // Prevent form submission
  } else {
    errorMessage.css('display', 'none'); // Hide the error message if shown

...
<div class="card card-app">
  ...
  <div class="card-body">
    <?php echo functions::form_draw_form_begin('order_status_form', 'post', false, true, 'id="status_form_id" onsubmit="return validateForm()"'); ?>
        ...
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="form-group col-md-4">
              ...
              <?php echo functions::form_draw_select_field('state', $state_options, true, 'id="state"'); ?>
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <?php echo functions::form_draw_text_field('icon', true, 'id="icon" placeholder="fa-circle-thin"'); ?>
...
<script>
  function validateForm() {
    const fields = [
      ...
      { id: 'state', message: '#error-message1' },
      { id: 'icon', message: '#error-message2' },
    ];

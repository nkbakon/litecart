...
<?php echo functions::form_draw_form_begin('form_order', 'post', false, true, 'id="order_form_id" onsubmit="return validateForm()"'); ?>
          ...
          <div id="customer-details" class="row layout" style="margin-bottom: 2em;">
            <div id="billing-address" class="col-md-6">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <?php echo functions::form_draw_text_field('customer[firstname]', true, 'id="bfname"'); ?>
                  <span id="error-message1" style="color: red; display: none;">This field is required.</span>
                </div>

                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_lastname', 'Last Name'); ?></label>
                  <?php echo functions::form_draw_text_field('customer[lastname]', true, 'id="blname"'); ?>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <?php echo functions::form_draw_text_field('customer[address1]', true, 'id="baddress"'); ?>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <?php echo functions::form_draw_text_field('customer[postcode]', true, 'id="bpostal"'); ?>
                  <span id="error-message4" style="color: red; display: none;">This field is required.</span>
                </div>

                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_city', 'City'); ?></label>
                  <?php echo functions::form_draw_text_field('customer[city]', true, 'id="bcity"'); ?>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <?php echo functions::form_draw_email_field('customer[email]', true, 'id="bemail" required'); ?>
                ...
                <div class="form-group col-md-6">
                  ...
                  <?php echo functions::form_draw_phone_field('customer[phone]', true, 'id="bphone"'); ?>
                  <span id="error-message7" style="color: red; display: none;">This field is required.</span>
                  <span id="error-message23" style="color: red; display: none;">Please enter a valid phone number.</span>
                </div>
              </div>
            ...
            <div id="shipping-address" class="col-md-6">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_firstname', 'First Name'); ?></label>
                  <?php echo functions::form_draw_text_field('customer[shipping_address][firstname]', true, 'id="sfname"'); ?>
                  <span id="error-message8" style="color: red; display: none;">This field is required.</span>
                </div>

                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_lastname', 'Last Name'); ?></label>
                  <?php echo functions::form_draw_text_field('customer[shipping_address][lastname]', true, 'id="slname"'); ?>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_address1', 'Address 1'); ?></label>
                  <?php echo functions::form_draw_text_field('customer[shipping_address][address1]', true, 'id="saddress"'); ?>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_postcode', 'Postal Code'); ?></label>
                  <?php echo functions::form_draw_text_field('customer[shipping_address][postcode]', true, 'id="spostal"'); ?>
                  <span id="error-message11" style="color: red; display: none;">This field is required.</span>
                </div>

                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_city', 'City'); ?></label>
                  <?php echo functions::form_draw_text_field('customer[shipping_address][city]', true, 'id="scity"'); ?>
                  <span id="error-message12" style="color: red; display: none;">This field is required.</span>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_phone', 'Phone'); ?></label>
                  <?php echo functions::form_draw_phone_field('customer[shipping_address][phone]', true, 'id="sphone"'); ?>
                  <span id="error-message13" style="color: red; display: none;">This field is required.</span>
                  <span id="error-message24" style="color: red; display: none;">Please enter a valid phone number.</span>
                </div>
              </div>
            </div>
          ...
          <div class="row" id="payment-details">
            <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <?php echo functions::form_draw_text_field('payment_option[name]', true, 'id="pname"'); ?>
                  <span id="error-message14" style="color: red; display: none;">This field is required.</span>
                </div>
              </div>

              <div class="form-group">
                <label><?php echo language::translate('title_transaction_id', 'Transaction ID'); ?></label>
                <?php echo functions::form_draw_text_field('payment_transaction_id', true, 'id="ptransid"'); ?>
                <span id="error-message15" style="color: red; display: none;">This field is required.</span>
              </div>

              <div class="form-group">
                <label><?php echo language::translate('title_receipt_url', 'Receipt URL'); ?></label>
                <?php echo functions::form_draw_url_field('payment_receipt_url', true, 'id="preceipt"'); ?>
                <span id="error-message16" style="color: red; display: none;">This field is required.</span>
              </div>

              <div class="row">
                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_payment_terms', 'Payment Terms'); ?></label>
                  <?php echo functions::form_draw_payment_terms_list('payment_terms', true, 'id="pterms"'); ?>
                  <span id="error-message17" style="color: red; display: none;">This field is required.</span>
                </div>

                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_date_paid', 'Date Paid'); ?></label>
                  <?php echo functions::form_draw_datetime_field('date_paid', true, 'id="pdate"'); ?>
                  <span id="error-message18" style="color: red; display: none;">This field is required.</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6" id="shipping-details">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label><?php echo language::translate('title_name', 'Name'); ?></label>
                  <?php echo functions::form_draw_text_field('shipping_option[name]', true, 'id="shname"'); ?>
                  <span id="error-message19" style="color: red; display: none;">This field is required.</span>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-8">
                  ...
                  <?php echo functions::form_draw_text_field('shipping_tracking_id', true, 'id="shtrackid"'); ?>
                  <span id="error-message20" style="color: red; display: none;">This field is required.</span>
                </div>
              ...
              <div class="form-group">
                ...
                <?php echo functions::form_draw_url_field('shipping_tracking_url', true, 'id="shtrackurl"'); ?>
                <span id="error-message21" style="color: red; display: none;">This field is required.</span>
              </div>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <?php echo functions::form_draw_datetime_field('date_dispatched', true, 'id="shdate"'); ?>
                  <span id="error-message22" style="color: red; display: none;">This field is required.</span>
                </div>
              </div>
...
function validateForm() {
  const fields = [
    { id: 'bfname', message: '#error-message1' },
    { id: 'blname', message: '#error-message2' },
    { id: 'baddress', message: '#error-message3' },
    { id: 'bpostal', message: '#error-message4' },
    { id: 'bcity', message: '#error-message5' },
    { id: 'bemail', message: '#error-message6' },
    { id: 'bphone', message: '#error-message7' },
    { id: 'sfname', message: '#error-message8' },
    { id: 'slname', message: '#error-message9' },
    { id: 'saddress', message: '#error-message10' },
    { id: 'spostal', message: '#error-message11' },
    { id: 'scity', message: '#error-message12' },
    { id: 'sphone', message: '#error-message13' },
    { id: 'pname', message: '#error-message14' },
    { id: 'ptransid', message: '#error-message15' },
    { id: 'preceipt', message: '#error-message16' },
    { id: 'pterms', message: '#error-message17' },
    { id: 'pdate', message: '#error-message18' },
    { id: 'shname', message: '#error-message19' },
    { id: 'shtrackid', message: '#error-message20' },
    { id: 'shtrackurl', message: '#error-message21' },
    { id: 'shdate', message: '#error-message22' },
  ];
  ...
  const bphoneField = $('#bphone');
  const bphoneErrorMessage = $('#error-message23');
  const bphoneRegex = /^(\+?\d+)?\d+$/;

  if (bphoneField.val().trim() !== '' && (!bphoneRegex.test(bphoneField.val().trim())  || bphoneField.val().trim().replace(/[^\d]/g, '').length < 10)) {
    bphoneErrorMessage.css('display', 'inline');
    isValid = false;
  } else {
    bphoneErrorMessage.css('display', 'none');
  }

  const sphoneField = $('#sphone');
  const sphoneErrorMessage = $('#error-message24');
  const sphoneRegex = /^(\+?\d+)?\d+$/;

  if (sphoneField.val().trim() !== '' && (!sphoneRegex.test(sphoneField.val().trim())  || sphoneField.val().trim().replace(/[^\d]/g, '').length < 10)) {
    sphoneErrorMessage.css('display', 'inline');
    isValid = false;
  } else {
    sphoneErrorMessage.css('display', 'none');
  }
